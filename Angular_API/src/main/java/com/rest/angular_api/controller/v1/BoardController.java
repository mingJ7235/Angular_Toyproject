...
public class BoardController {
    ...
    @ApiOperation(value = "게시판 글 작성", notes = "게시판 글 작성 api")
    ...
    @ApiOperation(value = "게시판 글 상세", notes = "게시판 글 상세정보 조회 api")
    ...
    @ApiOperation(value = "게시판 글 수정", notes = "게시판 글 수정 api")
    ...
    @ApiOperation(value = "게시판 글 삭제", notes = "게시판 글 삭제 api")
